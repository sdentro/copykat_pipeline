...
# Plain run:
# Rscript copykat_pipeline.R -c /Users/sdentro/Documents/reference_papers/darmanis_et_al_2017/GBM_data_and_metadata/GBM_raw_gene_counts.csv.gz -u /Users/sdentro/Documents/projects/2021_09_gbm/2021_09_22_public_sc_data/umap_with_celltype_and_cluster.txt -g ~/Documents/repo/battenberg/gcCorrect_chromosome_coordinates_hg19.txt -o output
#
# Plain run without UMAP:
# Rscript copykat_pipeline.R -c /Users/sdentro/Documents/reference_papers/darmanis_et_al_2017/GBM_data_and_metadata/GBM_raw_gene_counts.csv.gz -g ~/Documents/repo/battenberg/gcCorrect_chromosome_coordinates_hg19.txt -o output
#
# Labels reversed:
# Rscript copykat_pipeline.R -c /Users/sdentro/Documents/reference_papers/darmanis_et_al_2017/GBM_data_and_metadata/GBM_raw_gene_counts.csv.gz -u /Users/sdentro/Documents/projects/2021_09_gbm/2021_09_22_public_sc_data/umap_with_celltype_and_cluster.txt -g ~/Documents/repo/battenberg/gcCorrect_chromosome_coordinates_hg19.txt -o output -l output/copykat_copykat_prediction_reversed.txt

# TODO:
# See TODOs for extra plots in this script
# fix warnings generated by distribution plots
...
#' @param genome_coords Data frame with genomic coordinates identifying chromosome and centromere start/end. Required columns: chr, start, cen.left.base, cen.right.base, end
#' 
call_alterations = function(CNA_data, predictions, genome_coords) {
  ...
  for (i in 1:length(chrom_names)) {
    chrom = chrom_names[i]
    res_q = assess_chromarm(chrom = chrom, arm="q", CNA_data = CNA_data, genome_coords = genome_coords, cell_labels=predictions, calling_threshold=0.5)
    res_p = assess_chromarm(chrom = chrom, arm="p", CNA_data = CNA_data, genome_coords = genome_coords, cell_labels=predictions, calling_threshold=0.5)
...
genome_coords = read.table(genome_coords_file, header=T) #"~/Documents/repo/battenberg/gcCorrect_chromosome_coordinates_hg19.txt"
...
copykat_res <- copykat(rawmat=counts,
                        ...
                        ngene.chr=5,
                        win.size=25,
                        # norm.cell.names=c(cna_summary_data$cell[!cna_summary_data$is_aneuploid & !cna_summary_data$is_aneuploid_copykat],
                        #                   cna_summary_data$cell[!cna_summary_data$is_aneuploid & cna_summary_data$is_aneuploid_copykat]),
...
calls_res = call_alterations(CNA_data, predictions, genome_coords)
...
# TODO: This can be made more generic to plot for every category beyond UMAP_1/UMAP_2/cell
...
# TODO: Add a plot after running cutree(copykat_res$hclustering, [value]) for values ranging from 2 to 10. plot pileup and umap
